...
local function get_random_footer_quote()
  local footer_quotes = {
    ...
    { "The power from the Lady Stone lets you regenerate Health and Stamina much faster for a while." },
    {
    ...
    {
      "Imperials are natives of Cyrodiil, the cosmopolitan heartland of the Empire. Once a day, they can use the Voice of the Emperor power to calm an angry opponent for a short while.",
    },
    {
      "Khajiit have deadly claws that can be used in unarmed combat. They can use Night Eye to see better in the dark.",
    },
    { "Nords are 50% resistant to cold damage. They can use Battle Cry to make their enemies flee, for a short time." },
    ...
    { "Pelagius III, sometimes called Pelagius the Mad, was proclaimed Emperor in the 145th year of the Third Era." },
    ...
    { "An excessively high bounty will cause a Hold Guard to attack the wanted person on sight." },
    {
