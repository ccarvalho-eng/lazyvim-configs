return {
  {
    ...
    ft = { "org" },
    config = function()
      local agenda_dir = os.getenv("ORG_NOTES")
      ...
      local function create_journal_template(date)
        local template = {
          ...
          "* Morning Routine [/]",
          "** TODO Water",
          "   SCHEDULED: <" .. date .. " 06:00>",
          "** TODO Exercise",
          "   SCHEDULED: <" .. date .. " 07:00>",
          "** TODO Meditation",
          "   SCHEDULED: <" .. date .. " 08:15>",
          "** TODO Breakfast",
          "   SCHEDULED: <" .. date .. " 08:30>",
          "** TODO Reading",
          "   SCHEDULED: <" .. date .. " 08:30>",
          "** TODO Play with my son",
          "   SCHEDULED: <" .. date .. " 09:00>",
          "** TODO House Chores",
          "   SCHEDULED: <" .. date .. " 10:00>",
          "",
          "* Inbox",
          "** TODO Messages",
          "** TODO Email",
      ...
      vim.keymap.set("n", "<Leader>on", function()
        vim.cmd("Ex " .. os.getenv("ORG_NOTES"))
